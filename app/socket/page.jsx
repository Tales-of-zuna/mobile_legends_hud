        ...
        player_list: [
          {
            ...
            equip_list: [3541, 3107, 2104, 2101],
            map_pos: {
              x: -47.984375,
              y: 0.11999512,
            },
          ...
          },
          {
            ...
            equip_list: [3421, 3203, 3210, 2201, 1204, 1201],
            map_pos: {
              x: -19.417969,
              y: -8.277344,
            },
          ...
          },
          {
            ...
            equip_list: [3002, 2305, 3003, 3005, 1001],
            map_pos: {
              x: -28.011719,
              y: -20.859375,
            },
          ...
          },
          {
            ...
            equip_list: [2304, 3107, 3110, 1101],
            map_pos: {
              x: -30.042969,
              y: -10.480469,
            },
          ...
          },
          {
            ...
            equip_list: [2302, 3009, 3206, 2205, 1001, 1001],
            map_pos: {
              x: -39.75,
              y: 0.55200195,
            },
        ...
        player_list: [
          {
            ...
            equip_list: [3107, 2304, 3110, 1105, 2101],
            map_pos: {
              x: -35.28125,
              y: -0.4710083,
            },
          ...
          },
          {
            ...
            equip_list: [3423, 1002, 2013, 2209, 3004, 2203],
            map_pos: {
              x: -39.46875,
              y: 1.5756836,
            },
          ...
          },
          {
            ...
            equip_list: [2206, 3007, 2302, 3001, 2011, 1006],
            map_pos: {
              x: -39.273438,
              y: 3.2841797,
            },
          ...
          },
          {
            ...
            equip_list: [2302, 2004, 3206, 3010, 2203, 1201],
            map_pos: {
              x: -35.476562,
              y: -4.5371094,
            },
          ...
          },
          {
            ...
            equip_list: [3521, 3205, 2201, 2205, 1202],
            map_pos: {
              x: -39.007812,
              y: 2.078125,
            },
      ...
      <div className=" bg-black bg-opacity-70 p-4 absolute bottom-0 left-0 right-0">
        ...
        <div className=" flex flex-row">
          ...
          {campList1[0]?.player_list.map((player) => (
            <div key={player.name} className=" bg-gray-800 rounded-lg p-2">
